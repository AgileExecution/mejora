defmodule MejoraWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {MejoraWeb.Layouts, :root}
  ...
  # scope "/api", MejoraWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:mejora, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: MejoraWeb.Telemetry
  ...
  scope "/", MejoraWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{MejoraWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", MejoraWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{MejoraWeb.UserAuth, :ensure_authenticated}] do
